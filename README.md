# Getting Started with Simple Online Paint App

This project created by courses found in internet to practice such skills as ReactJS, Canvas and WebSocket, how to
realise online paint app using JavaScript etc. and is just a test version
